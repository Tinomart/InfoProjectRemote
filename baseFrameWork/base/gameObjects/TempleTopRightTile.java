...
public class TempleTopRightTile extends StructureTile {

	public TempleTopRightTile(Point tilePosition, TileGrid tileGrid) {

		super(tilePosition, tileGrid, new Sprite(new Point(0, 0)));
		spriteType = SpriteType.TempleTopRightSprite;
	}
