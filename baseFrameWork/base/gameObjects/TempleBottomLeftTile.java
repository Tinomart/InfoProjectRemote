...
public class TempleBottomLeftTile extends StructureTile {

	public TempleBottomLeftTile(Point tilePosition, TileGrid tileGrid) {

		super(tilePosition, tileGrid, new Sprite(new Point(0, 0)));
		spriteType = SpriteType.TempleBottomLeftSprite;
	}
