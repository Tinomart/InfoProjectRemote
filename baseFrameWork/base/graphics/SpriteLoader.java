...
public class SpriteLoader {
	public enum SpriteType{
		...
		CircleSprite,
		GrassTileSprite,
		GrassFlowerTile_1Sprite,
		GrassTreeTrunkTileSprite,
		PureGrassTileSprite,
		GrassFlower_2TileSprite,
		WaterTile_FishSprite,
		BeachTile_LeftBottomSprite,
		BeachTile_BottomSprite,
		BeachTile_RightBottomSprite,
		BeachTile_TopSprite,
		BeachTile_LeftTopSprite,
		BeachTile_RightTopSprite,
		BeachTile_LeftSprite,
		BeachTile_RightSprite,
		WaterTileSprite,
		WaterTile_DucksSprite,
