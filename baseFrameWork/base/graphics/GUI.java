...
//-----------------------------------------------------------------------------	
	...
	public static void addInGameGUI(GamePanel panel) {
		...
		// TODO replace the name of "ressources1,2,3" to the ressources we want to
		// implement
	...
	// TODO obviously need to add code for getting the object from the buttons to
	// the gamefield
	...
	// this method is for the GridBagLayout and includes the variables for different
	// UI elements
